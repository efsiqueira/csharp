...
namespace Views
{
    public class FormDentistaInsert : Form
    {
        ...
        private void btConfirmarClick(object sender, EventArgs e)
        {
            ...
            int idEspecialidade = int.Parse(textEspecialidadeId.Text);
            try
            {
        ...
        Dentista dentista;
        public FormDentistaInsert(int id)
        {
            this.ClientSize = new System.Drawing.Size(400,420);
            this.id = id;

            dentista = DentistaController.GetDentista(id);
            ...
            btConfirmar.Location = new Point(90,360);
            btConfirmar.Size = new Size(100,25);
            btConfirmar.Click += new EventHandler(this.btConfirmarUpdateClick);
        ...
        private void btConfirmarUpdateClick(object sender, EventArgs e)
        {
            double salario = Convert.ToDouble(textSalario.Text);
            int idEspecialidade = Convert.ToInt32(textEspecialidadeId.Text);
            
            Dentista dentista = DentistaController.GetDentista(id);
